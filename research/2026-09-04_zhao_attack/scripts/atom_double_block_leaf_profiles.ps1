param(
    [ValidateSet('3222','2222')][string]$Mode = '3222',
    [int]$Cutoff = 13,
    [int]$Target = 17,
    [string]$OutputFile = '',
    [string]$SkipEvidence = '',
...
using System.IO;
using System.Text;
public static class AtomDoubleBlockLeafProfiles {
...
[AtomDoubleBlockLeafProfiles]::Run($Mode,$Cutoff,$Target,$OutputFile,[int[]]$atomSkip,$Seconds,$NodeLimit,$atomSha)
